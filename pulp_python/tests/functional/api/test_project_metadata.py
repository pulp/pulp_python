...
def test_cru_project_metadata(python_bindings, python_repo_factory, monitor_task):
    ...
    metadata1 = python_bindings.ContentProjectMetadataApi.read(task.result["pulp_href"])
    ...
    result = python_bindings.RepositoriesPythonApi.update_project(repo.pulp_href, body)
    task = monitor_task(result.task)
    metadata2 = python_bindings.ContentProjectMetadataApi.read(task.result["pulp_href"])
    ...
    result = python_bindings.RepositoriesPythonApi.update_project(repo.pulp_href, body)
    task = monitor_task(result.task)
    metadata3 = python_bindings.ContentProjectMetadataApi.read(task.result["pulp_href"])
    ...
    result = python_bindings.RepositoriesPythonApi.update_project(repo.pulp_href, body)
    task = monitor_task(result.task)
    metadata4 = python_bindings.ContentProjectMetadataApi.read(task.result["pulp_href"])
    ...
    result = python_bindings.RepositoriesPythonApi.update_project(repo.pulp_href, body)
    task = monitor_task(result.task)
    metadata5 = python_bindings.ContentProjectMetadataApi.read(task.result["pulp_href"])
...
def test_project_metadata_simple(
    ...
    result = python_bindings.RepositoriesPythonApi.update_project(repo.pulp_href, body)
    task = monitor_task(result.task)
    metadata = python_bindings.ContentProjectMetadataApi.read(task.result["pulp_href"])
