...
# A rebuild is a PEP 440 local version: from ``+`` through the end of the
# string. The public version is everything before ``+``. ``release`` is the
# local identifier without the leading ``+``.
@pytest.mark.parametrize(
    ...
    [
        ...
        ("5.3.18", "5.3.18"),
        ("5.3.180", "5.3.180"),
        ("5.3.17+test.1", "5.3.17"),
        ("5.3.18+test.2", "5.3.18"),
        ("5.3.17+test.1.n1", "5.3.17"),
        ("5.3.17+test.1.n1.hf2", "5.3.17"),
        ("1.0.0+foo.bar", "1.0.0"),
        ("1.2.3a1+test.1", "1.2.3a1"),
        ("1!1.2.3+test.1", "1!1.2.3"),
        ("1.0+", "1.0"),
        ("4.3.0-redhat-1", "4.3.0-redhat-1"),
        ("5.3.18-anything", "5.3.18-anything"),
        ("5.3.18.anything", "5.3.18.anything"),
        ("5.3.17.test-00001", "5.3.17.test-00001"),
        ("1.0.test-1.extra", "1.0.test-1.extra"),
        ("", ""),
        (None, None),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("5.3.18", ""),
        ("5.3.17+test.1", "test.1"),
        ("5.3.18+test.2", "test.2"),
        ("5.3.17+test.1.n1", "test.1.n1"),
        ("5.3.17+test.1.n1.hf2", "test.1.n1.hf2"),
        ("1.0.0+foo.bar", "foo.bar"),
        ("1.2.3a1+test.1", "test.1"),
        ("1.0+", ""),
        ("5.3.18.anything", ""),
        ("4.3.0-redhat-1", ""),
        ("5.3.18-anything", ""),
